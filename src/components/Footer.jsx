...
const FooterContent = () => {
    return (
        <>
            <div>
                <p className="text-4xl bold py-6">Travel With Us</p>
                <p className="text-2xl bold ">Tourism</p>
                <p className="text-2xl semi-bold">Sydney, Australia</p>
            </div>
        </>
    )
}
                ...
                <div className="Contact flex flex-col px-4 py-6 md:py-0">
                    ...
                    <div className="flex flex-col py-4">
                        ...
                        <div className="flex pl-2 py-2 gap-1 justify-center">
                            <a href="tel:+61 450080744"><MdOutlineLocalPhone size={25} /></a>
                            <a href="tel:+61 450080744">+61 450080744</a>
                        </div>

                        <div className="flex pl-2 py-2 gap-1 justify-center">
                            <a href="https://wa.me/+61 450080744"><FaWhatsapp size={25} /></a>
                            <a href="https://wa.me/+61 450080744">+61 450080744</a>
                        </div>

                        <div className="flex pl-2 py-2 gap-1 justify-center">
                            <a href="mailto:traveldestination@gmail.com"><CgMail size={25} /></a>
                            <a href="mailto:traveldestination@gmail.com">tourism@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
